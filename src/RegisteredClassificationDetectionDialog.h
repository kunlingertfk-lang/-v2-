#ifndef REGISTEREDCLASSIFICATIONDETECTIONDIALOG_H
#define REGISTEREDCLASSIFICATIONDETECTIONDIALOG_H
...
public:
    explicit RegisteredClassificationDetectionDialog(QWidget *parent = nullptr);
    ~RegisteredClassificationDetectionDialog() override;
...
private:
    ...
    ToolResult backendNotImplementedResult() const;
    void showTodoMessage(const QString &actionName);
    void updateModelLabels();
    QJsonObject registeredClassificationDetectionParams() const;
...
#endif // REGISTEREDCLASSIFICATIONDETECTIONDIALOG_H
