...
CONFIG -= app_bundle
TEMPLATE = app
TARGET = registered_classification_dataset_smoke

BUILD_ROOT = $$_PRO_FILE_PWD_/../build/smoke/registered_classification_dataset
...
SOURCES += \
    registered_classification_dataset_smoke.cpp \
