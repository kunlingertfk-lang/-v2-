...
CONFIG -= app_bundle
TEMPLATE = app
TARGET = circle_position_correction_smoke

isEmpty(BUILD_ROOT): BUILD_ROOT = $$_PRO_FILE_PWD_/../build/smoke/circle_position_correction
...
SOURCES += \
    circle_position_correction_smoke.cpp \
