...
CONFIG -= app_bundle
TEMPLATE = app
TARGET = blob_position_correction_smoke

isEmpty(BUILD_ROOT): BUILD_ROOT = $$_PRO_FILE_PWD_/../build/smoke/blob_position_correction
...
SOURCES += \
    blob_position_correction_smoke.cpp \
