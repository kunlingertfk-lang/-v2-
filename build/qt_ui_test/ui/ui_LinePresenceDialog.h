/********************************************************************************
** Form generated from reading UI file 'LinePresenceDialog.ui'
**
...
#ifndef UI_LINEPRESENCEDIALOG_H
#define UI_LINEPRESENCEDIALOG_H
...
public:
    ...
    QToolButton *lineExternalEditButton;
    ...
    QStackedWidget *lineParamsStackedWidget;
    QWidget *basicParamsPage;
    QVBoxLayout *verticalLayout_basicParamsPage;
    QScrollArea *lineBasicParamsScrollArea;
    QWidget *lineBasicParamsContents;
    ...
    QSpinBox *lineBasicSensitivitySpinBox;
    ...
    QScrollArea *lineAllParamsScrollArea;
    QWidget *lineAllParamsContents;
    ...
    QSpinBox *lineSensitivitySpinBox;
    QHBoxLayout *horizontalLayout_lineDegree;
    QLabel *lineDegreeLabel;
    QSpinBox *lineDegreeSpinBox;
    QHBoxLayout *horizontalLayout_edgePolarity;
    QLabel *edgePolarityLabel;
    QComboBox *edgePolarityComboBox;
    QHBoxLayout *horizontalLayout_edgeType;
    ...
    void setupUi(QDialog *LinePresenceDialog)
    {
        if (LinePresenceDialog->objectName().isEmpty())
            LinePresenceDialog->setObjectName(QString::fromUtf8("LinePresenceDialog"));
        LinePresenceDialog->resize(1760, 980);
        verticalLayout_root = new QVBoxLayout(LinePresenceDialog);
        ...
        setupTopBar = new QFrame(LinePresenceDialog);
        ...
        setupToolbar = new QFrame(LinePresenceDialog);
        ...
        setupBodyFrame = new QFrame(LinePresenceDialog);
        ...
        lineExternalEditButton = new QToolButton(setupEditorPanel);
        lineExternalEditButton->setObjectName(QString::fromUtf8("lineExternalEditButton"));
        lineExternalEditButton->setIcon(icon);
        lineExternalEditButton->setIconSize(QSize(24, 24));
        lineExternalEditButton->setAutoRaise(true);

        horizontalLayout_editorHeader->addWidget(lineExternalEditButton);
        ...
        lineParamsStackedWidget = new QStackedWidget(setupEditorPanel);
        lineParamsStackedWidget->setObjectName(QString::fromUtf8("lineParamsStackedWidget"));
        ...
        lineBasicParamsScrollArea = new QScrollArea(basicParamsPage);
        lineBasicParamsScrollArea->setObjectName(QString::fromUtf8("lineBasicParamsScrollArea"));
        lineBasicParamsScrollArea->setFrameShape(QFrame::NoFrame);
        lineBasicParamsScrollArea->setVerticalScrollBarPolicy(Qt::ScrollBarAsNeeded);
        lineBasicParamsScrollArea->setHorizontalScrollBarPolicy(Qt::ScrollBarAlwaysOff);
        lineBasicParamsScrollArea->setWidgetResizable(true);
        lineBasicParamsContents = new QWidget();
        lineBasicParamsContents->setObjectName(QString::fromUtf8("lineBasicParamsContents"));
        lineBasicParamsContents->setGeometry(QRect(0, 0, 554, 692));
        verticalLayout_basicConfigCards = new QVBoxLayout(lineBasicParamsContents);
        ...
        basicDetectionAreaCard = new QFrame(lineBasicParamsContents);
        ...
        basicRecognitionSettingsCard = new QFrame(lineBasicParamsContents);
        ...
        lineBasicSensitivitySpinBox = new QSpinBox(basicRecognitionSettingsCard);
        lineBasicSensitivitySpinBox->setObjectName(QString::fromUtf8("lineBasicSensitivitySpinBox"));
        lineBasicSensitivitySpinBox->setMinimumSize(QSize(260, 38));
        lineBasicSensitivitySpinBox->setMinimum(0);
        lineBasicSensitivitySpinBox->setMaximum(100);
        lineBasicSensitivitySpinBox->setValue(60);

        basicHorizontalLayout_sensitivity->addWidget(lineBasicSensitivitySpinBox);
        ...
        basicResultJudgeCard = new QFrame(lineBasicParamsContents);
        ...
        lineBasicParamsScrollArea->setWidget(lineBasicParamsContents);

        verticalLayout_basicParamsPage->addWidget(lineBasicParamsScrollArea);

        lineParamsStackedWidget->addWidget(basicParamsPage);
        ...
        lineAllParamsScrollArea = new QScrollArea(allParamsPage);
        lineAllParamsScrollArea->setObjectName(QString::fromUtf8("lineAllParamsScrollArea"));
        lineAllParamsScrollArea->setFrameShape(QFrame::NoFrame);
        lineAllParamsScrollArea->setVerticalScrollBarPolicy(Qt::ScrollBarAsNeeded);
        lineAllParamsScrollArea->setHorizontalScrollBarPolicy(Qt::ScrollBarAlwaysOff);
        lineAllParamsScrollArea->setWidgetResizable(true);
        lineAllParamsContents = new QWidget();
        lineAllParamsContents->setObjectName(QString::fromUtf8("lineAllParamsContents"));
        lineAllParamsContents->setGeometry(QRect(0, 0, 554, 692));
        verticalLayout_allConfigCards = new QVBoxLayout(lineAllParamsContents);
        ...
        detectionAreaCard = new QFrame(lineAllParamsContents);
        ...
        recognitionSettingsCard = new QFrame(lineAllParamsContents);
        ...
        lineSensitivitySpinBox = new QSpinBox(recognitionSettingsCard);
        lineSensitivitySpinBox->setObjectName(QString::fromUtf8("lineSensitivitySpinBox"));
        lineSensitivitySpinBox->setMinimumSize(QSize(260, 38));
        lineSensitivitySpinBox->setMinimum(0);
        lineSensitivitySpinBox->setMaximum(100);
        lineSensitivitySpinBox->setValue(60);

        horizontalLayout_sensitivity->addWidget(lineSensitivitySpinBox);


        verticalLayout_recognitionSettings->addLayout(horizontalLayout_sensitivity);

        horizontalLayout_lineDegree = new QHBoxLayout();
        horizontalLayout_lineDegree->setObjectName(QString::fromUtf8("horizontalLayout_lineDegree"));
        horizontalLayout_lineDegree->setContentsMargins(0, 0, 0, 0);
        lineDegreeLabel = new QLabel(recognitionSettingsCard);
        lineDegreeLabel->setObjectName(QString::fromUtf8("lineDegreeLabel"));
        lineDegreeLabel->setMinimumSize(QSize(150, 0));

        horizontalLayout_lineDegree->addWidget(lineDegreeLabel);

        lineDegreeSpinBox = new QSpinBox(recognitionSettingsCard);
        lineDegreeSpinBox->setObjectName(QString::fromUtf8("lineDegreeSpinBox"));
        lineDegreeSpinBox->setMinimumSize(QSize(260, 38));
        lineDegreeSpinBox->setMinimum(0);
        lineDegreeSpinBox->setMaximum(100);
        lineDegreeSpinBox->setValue(25);

        horizontalLayout_lineDegree->addWidget(lineDegreeSpinBox);


        verticalLayout_recognitionSettings->addLayout(horizontalLayout_lineDegree);
        ...
        horizontalLayout_edgeType = new QHBoxLayout();
        horizontalLayout_edgeType->setObjectName(QString::fromUtf8("horizontalLayout_edgeType"));
        horizontalLayout_edgeType->setContentsMargins(0, 0, 0, 0);
        edgeTypeLabel = new QLabel(recognitionSettingsCard);
        edgeTypeLabel->setObjectName(QString::fromUtf8("edgeTypeLabel"));
        edgeTypeLabel->setMinimumSize(QSize(150, 0));

        horizontalLayout_edgeType->addWidget(edgeTypeLabel);

        edgeTypeComboBox = new QComboBox(recognitionSettingsCard);
        edgeTypeComboBox->addItem(QString());
        edgeTypeComboBox->addItem(QString());
        edgeTypeComboBox->addItem(QString());
        edgeTypeComboBox->addItem(QString());
        edgeTypeComboBox->setObjectName(QString::fromUtf8("edgeTypeComboBox"));
        edgeTypeComboBox->setMinimumSize(QSize(260, 38));

        horizontalLayout_edgeType->addWidget(edgeTypeComboBox);


        verticalLayout_recognitionSettings->addLayout(horizontalLayout_edgeType);


        verticalLayout_allConfigCards->addWidget(recognitionSettingsCard);

        resultJudgeCard = new QFrame(lineAllParamsContents);
        ...
        lineAllParamsScrollArea->setWidget(lineAllParamsContents);

        verticalLayout_allParamsPage->addWidget(lineAllParamsScrollArea);

        lineParamsStackedWidget->addWidget(allParamsPage);

        verticalLayout_editor->addWidget(lineParamsStackedWidget);
        ...
        retranslateUi(LinePresenceDialog);

        lineParamsStackedWidget->setCurrentIndex(1);
        edgePolarityComboBox->setCurrentIndex(2);


        QMetaObject::connectSlotsByName(LinePresenceDialog);
    } // setupUi

    void retranslateUi(QDialog *LinePresenceDialog)
    {
        LinePresenceDialog->setWindowTitle(QCoreApplication::translate("LinePresenceDialog", "\346\226\271\346\241\210\347\274\226\350\276\221 - \347\233\264\347\272\277\346\234\211\346\227\240", nullptr));
        setupWindowTitleLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\346\226\271\346\241\210\347\274\226\350\276\221", nullptr));
        headerMaximizeButton->setText(QCoreApplication::translate("LinePresenceDialog", "\342\226\241", nullptr));
        headerCloseButton->setText(QCoreApplication::translate("LinePresenceDialog", "\303\227", nullptr));
        setupPageCodeLabel->setText(QCoreApplication::translate("LinePresenceDialog", "428", nullptr));
        setupSaveButton->setText(QCoreApplication::translate("LinePresenceDialog", "\344\277\235\345\255\230", nullptr));
        setupSaveAsButton->setText(QCoreApplication::translate("LinePresenceDialog", "\345\217\246\345\255\230\344\270\272", nullptr));
        setupExportButton->setText(QCoreApplication::translate("LinePresenceDialog", "IO\350\276\223\345\207\272", nullptr));
        editorTitleLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\347\233\264\347\272\277\346\234\211\346\227\240", nullptr));
        basicSegmentButton->setText(QCoreApplication::translate("LinePresenceDialog", "\345\237\272\347\241\200", nullptr));
        allSegmentButton->setText(QCoreApplication::translate("LinePresenceDialog", "\345\205\250\351\203\250", nullptr));
        basicDetectionAreaCard->setProperty("panelRole", QVariant(QCoreApplication::translate("LinePresenceDialog", "configCard", nullptr)));
        basicDetectionAreaTitleLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\346\243\200\346\265\213\345\214\272\345\237\237", nullptr));
        basicDetectionAreaTitleLabel->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "cardTitle", nullptr)));
        basicDetectionCollapseButton->setText(QCoreApplication::translate("LinePresenceDialog", "\342\214\204", nullptr));
        basicDetectionCollapseButton->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "collapseCard", nullptr)));
        basicDetectionAreaLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\346\243\200\346\265\213\345\214\272 \342\223\230", nullptr));
        basicDetectionAreaLabel->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "rowField", nullptr)));
#if QT_CONFIG(tooltip)
        basicDetectionRectButton->setToolTip(QCoreApplication::translate("LinePresenceDialog", "\347\202\271\345\207\273\345\220\216\345\234\250\345\217\263\344\276\247\347\273\230\345\210\266\347\272\277\345\236\213\346\220\234\347\264\242 ROI", nullptr));
#endif // QT_CONFIG(tooltip)
        basicDetectionRectButton->setText(QCoreApplication::translate("LinePresenceDialog", "\347\272\277\345\236\213 ROI", nullptr));
        basicDetectionRectButton->setProperty("actionRole", QVariant(QCoreApplication::translate("LinePresenceDialog", "toolbarIcon", nullptr)));
        basicPositionEnableLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\347\213\254\347\253\213\344\275\215\347\275\256\344\277\256\346\255\243\344\275\277\350\203\275 \342\223\230", nullptr));
        basicPositionEnableLabel->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "rowField", nullptr)));
        basicPositionCorrectionSwitch->setText(QString());
        basicPositionSourceLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\344\275\215\347\275\256\344\277\256\346\255\243", nullptr));
        basicPositionSourceLabel->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "rowField", nullptr)));
        basicPositionCorrectionComboBox->setItemText(0, QCoreApplication::translate("LinePresenceDialog", "1 \345\237\272\345\207\206\345\233\276.\344\275\215\347\275\256\344\277\256\346\255\243\344\277\241\346\201\257", nullptr));

        basicRecognitionSettingsCard->setProperty("panelRole", QVariant(QCoreApplication::translate("LinePresenceDialog", "configCard", nullptr)));
        basicRecognitionSettingsTitleLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\350\257\206\345\210\253\350\256\276\347\275\256", nullptr));
        basicRecognitionSettingsTitleLabel->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "cardTitle", nullptr)));
        basicRecognitionCollapseButton->setText(QCoreApplication::translate("LinePresenceDialog", "\342\214\204", nullptr));
        basicRecognitionCollapseButton->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "collapseCard", nullptr)));
        basicSensitivityLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\347\201\265\346\225\217\345\272\246", nullptr));
        basicSensitivityLabel->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "rowField", nullptr)));
        basicResultJudgeCard->setProperty("panelRole", QVariant(QCoreApplication::translate("LinePresenceDialog", "configCard", nullptr)));
        basicResultJudgeTitleLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\347\273\223\346\236\234\345\210\244\346\226\255", nullptr));
        basicResultJudgeTitleLabel->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "cardTitle", nullptr)));
        basicResultPresenceFrame->setProperty("panelRole", QVariant(QCoreApplication::translate("LinePresenceDialog", "optionGroup", nullptr)));
        basicPresentOkButton->setText(QCoreApplication::translate("LinePresenceDialog", "\345\255\230\345\234\250OK", nullptr));
        basicAbsentOkButton->setText(QCoreApplication::translate("LinePresenceDialog", "\344\270\215\345\255\230\345\234\250OK", nullptr));
        detectionAreaCard->setProperty("panelRole", QVariant(QCoreApplication::translate("LinePresenceDialog", "configCard", nullptr)));
        detectionAreaTitleLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\346\243\200\346\265\213\345\214\272\345\237\237", nullptr));
        detectionAreaTitleLabel->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "cardTitle", nullptr)));
        detectionCollapseButton->setText(QCoreApplication::translate("LinePresenceDialog", "\342\214\204", nullptr));
        detectionCollapseButton->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "collapseCard", nullptr)));
        detectionAreaLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\346\243\200\346\265\213\345\214\272 \342\223\230", nullptr));
        detectionAreaLabel->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "rowField", nullptr)));
#if QT_CONFIG(tooltip)
        detectionRectButton->setToolTip(QCoreApplication::translate("LinePresenceDialog", "\347\202\271\345\207\273\345\220\216\345\234\250\345\217\263\344\276\247\347\273\230\345\210\266\347\272\277\345\236\213\346\220\234\347\264\242 ROI", nullptr));
#endif // QT_CONFIG(tooltip)
        detectionRectButton->setText(QCoreApplication::translate("LinePresenceDialog", "\347\272\277\345\236\213 ROI", nullptr));
        detectionRectButton->setProperty("actionRole", QVariant(QCoreApplication::translate("LinePresenceDialog", "toolbarIcon", nullptr)));
        detectionMaskLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\345\261\217\350\224\275\345\214\272\345\237\237", nullptr));
        detectionMaskLabel->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "rowField", nullptr)));
        detectionMaskEditButton->setText(QCoreApplication::translate("LinePresenceDialog", "\347\274\226\350\276\221", nullptr));
        detectionMaskEditButton->setProperty("actionRole", QVariant(QCoreApplication::translate("LinePresenceDialog", "gray", nullptr)));
        positionEnableLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\347\213\254\347\253\213\344\275\215\347\275\256\344\277\256\346\255\243\344\275\277\350\203\275 \342\223\230", nullptr));
        positionEnableLabel->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "rowField", nullptr)));
        positionCorrectionSwitch->setText(QString());
        positionSourceLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\344\275\215\347\275\256\344\277\256\346\255\243", nullptr));
        positionSourceLabel->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "rowField", nullptr)));
        positionCorrectionComboBox->setItemText(0, QCoreApplication::translate("LinePresenceDialog", "1 \345\237\272\345\207\206\345\233\276.\344\275\215\347\275\256\344\277\256\346\255\243\344\277\241\346\201\257", nullptr));

        recognitionSettingsCard->setProperty("panelRole", QVariant(QCoreApplication::translate("LinePresenceDialog", "configCard", nullptr)));
        recognitionSettingsTitleLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\350\257\206\345\210\253\350\256\276\347\275\256", nullptr));
        recognitionSettingsTitleLabel->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "cardTitle", nullptr)));
        recognitionCollapseButton->setText(QCoreApplication::translate("LinePresenceDialog", "\342\214\204", nullptr));
        recognitionCollapseButton->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "collapseCard", nullptr)));
        sensitivityLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\347\201\265\346\225\217\345\272\246", nullptr));
        sensitivityLabel->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "rowField", nullptr)));
        lineDegreeLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\347\233\264\347\272\277\345\272\246 \342\223\230", nullptr));
        lineDegreeLabel->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "rowField", nullptr)));
        edgePolarityLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\350\276\271\347\274\230\346\236\201\346\200\247", nullptr));
        edgePolarityLabel->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "rowField", nullptr)));
        edgePolarityComboBox->setItemText(0, QCoreApplication::translate("LinePresenceDialog", "\351\273\221\345\210\260\347\231\275", nullptr));
        edgePolarityComboBox->setItemText(1, QCoreApplication::translate("LinePresenceDialog", "\347\231\275\345\210\260\351\273\221", nullptr));
        edgePolarityComboBox->setItemText(2, QCoreApplication::translate("LinePresenceDialog", "\344\273\273\346\204\217", nullptr));

        edgeTypeLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\350\276\271\347\274\230\347\261\273\345\236\213", nullptr));
        edgeTypeLabel->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "rowField", nullptr)));
        edgeTypeComboBox->setItemText(0, QCoreApplication::translate("LinePresenceDialog", "\346\234\200\345\274\272", nullptr));
        edgeTypeComboBox->setItemText(1, QCoreApplication::translate("LinePresenceDialog", "\347\254\254\344\270\200\346\235\241", nullptr));
        edgeTypeComboBox->setItemText(2, QCoreApplication::translate("LinePresenceDialog", "\346\234\200\345\220\216\344\270\200\346\235\241", nullptr));
        edgeTypeComboBox->setItemText(3, QCoreApplication::translate("LinePresenceDialog", "\346\211\213\345\212\250\351\200\211\346\213\251", nullptr));

        resultJudgeCard->setProperty("panelRole", QVariant(QCoreApplication::translate("LinePresenceDialog", "configCard", nullptr)));
        resultJudgeTitleLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\347\273\223\346\236\234\345\210\244\346\226\255", nullptr));
        resultJudgeTitleLabel->setProperty("role", QVariant(QCoreApplication::translate("LinePresenceDialog", "cardTitle", nullptr)));
        resultPresenceFrame->setProperty("panelRole", QVariant(QCoreApplication::translate("LinePresenceDialog", "optionGroup", nullptr)));
        presentOkButton->setText(QCoreApplication::translate("LinePresenceDialog", "\345\255\230\345\234\250OK", nullptr));
        absentOkButton->setText(QCoreApplication::translate("LinePresenceDialog", "\344\270\215\345\255\230\345\234\250OK", nullptr));
        referenceTestButton->setText(QCoreApplication::translate("LinePresenceDialog", "\345\237\272\345\207\206\345\233\276\346\265\213\350\257\225", nullptr));
        referenceTestButton->setProperty("actionRole", QVariant(QCoreApplication::translate("LinePresenceDialog", "secondary", nullptr)));
        testRunButton->setText(QCoreApplication::translate("LinePresenceDialog", "\346\265\213\350\257\225\350\277\220\350\241\214", nullptr));
        testRunButton->setProperty("actionRole", QVariant(QCoreApplication::translate("LinePresenceDialog", "secondary", nullptr)));
        finishButton->setText(QCoreApplication::translate("LinePresenceDialog", "\345\256\214\346\210\220", nullptr));
        viewerTitleLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\345\237\272\345\207\206\345\233\276", nullptr));
        viewerZoomOutButton->setText(QCoreApplication::translate("LinePresenceDialog", "-", nullptr));
        viewerZoomLabel->setText(QCoreApplication::translate("LinePresenceDialog", "39%", nullptr));
        viewerStatusLabel->setText(QCoreApplication::translate("LinePresenceDialog", "\347\256\227\346\263\225\350\200\227\346\227\266: --ms   \345\267\245\345\205\267\350\200\227\346\227\266: --ms", nullptr));
        viewerCursorLabel->setText(QCoreApplication::translate("LinePresenceDialog", "X: --  Y: ---   |   R: -- G: -- B: --", nullptr));
    } // retranslateUi

};

namespace Ui {
    class LinePresenceDialog: public Ui_LinePresenceDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_LINEPRESENCEDIALOG_H
