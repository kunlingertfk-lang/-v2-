/********************************************************************************
** Form generated from reading UI file 'PatternPresenceDialog.ui'
**
...
#ifndef UI_PATTERNPRESENCEDIALOG_H
#define UI_PATTERNPRESENCEDIALOG_H
...
class Ui_PatternPresenceDialog
{
public:
    ...
    QStackedWidget *patternParamsStackedWidget;
    ...
    QSpinBox *basicSensitivitySpinBox;
    ...
    QScrollArea *patternConfigScrollArea;
    QWidget *patternConfigContents;
    ...
    QHBoxLayout *horizontalLayout_templateSensitivity;
    QLabel *templateSensitivityLabel;
    QFrame *templateSensitivityFrame;
    QHBoxLayout *horizontalLayout_templateSensitivityButtons;
    QPushButton *templateManualButton;
    QPushButton *templateAutoButton;
    ...
    void setupUi(QDialog *PatternPresenceDialog)
    {
        if (PatternPresenceDialog->objectName().isEmpty())
            PatternPresenceDialog->setObjectName(QString::fromUtf8("PatternPresenceDialog"));
        PatternPresenceDialog->resize(1760, 980);
        verticalLayout_root = new QVBoxLayout(PatternPresenceDialog);
        ...
        setupTopBar = new QFrame(PatternPresenceDialog);
        ...
        setupToolbar = new QFrame(PatternPresenceDialog);
        ...
        setupBodyFrame = new QFrame(PatternPresenceDialog);
        ...
        patternParamsStackedWidget = new QStackedWidget(setupEditorPanel);
        patternParamsStackedWidget->setObjectName(QString::fromUtf8("patternParamsStackedWidget"));
        ...
        basicParamsContents->setGeometry(QRect(0, 0, 540, 714));
        ...
        basicSensitivityLabel = new QLabel(basicSearchTemplateCard);
        ...
        basicSensitivitySpinBox = new QSpinBox(basicSearchTemplateCard);
        basicSensitivitySpinBox->setObjectName(QString::fromUtf8("basicSensitivitySpinBox"));
        basicSensitivitySpinBox->setMinimumSize(QSize(260, 38));
        basicSensitivitySpinBox->setMinimum(1);
        basicSensitivitySpinBox->setMaximum(10);
        basicSensitivitySpinBox->setValue(2);

        basicHorizontalLayout_sensitivity->addWidget(basicSensitivitySpinBox);


        basicVerticalLayout_searchTemplate->addLayout(basicHorizontalLayout_sensitivity);
        ...
        patternParamsStackedWidget->addWidget(basicParamsPage);
        ...
        patternConfigScrollArea = new QScrollArea(allParamsPage);
        patternConfigScrollArea->setObjectName(QString::fromUtf8("patternConfigScrollArea"));
        patternConfigScrollArea->setFrameShape(QFrame::NoFrame);
        patternConfigScrollArea->setWidgetResizable(true);
        patternConfigContents = new QWidget();
        patternConfigContents->setObjectName(QString::fromUtf8("patternConfigContents"));
        patternConfigContents->setGeometry(QRect(0, -526, 540, 1218));
        verticalLayout_configCards = new QVBoxLayout(patternConfigContents);
        ...
        searchTemplateCard = new QFrame(patternConfigContents);
        ...
        horizontalLayout_templateSensitivity = new QHBoxLayout();
        horizontalLayout_templateSensitivity->setObjectName(QString::fromUtf8("horizontalLayout_templateSensitivity"));
        horizontalLayout_templateSensitivity->setContentsMargins(0, 0, 0, 0);
        templateSensitivityLabel = new QLabel(searchTemplateCard);
        templateSensitivityLabel->setObjectName(QString::fromUtf8("templateSensitivityLabel"));
        templateSensitivityLabel->setMinimumSize(QSize(150, 0));

        horizontalLayout_templateSensitivity->addWidget(templateSensitivityLabel);

        templateSensitivityFrame = new QFrame(searchTemplateCard);
        templateSensitivityFrame->setObjectName(QString::fromUtf8("templateSensitivityFrame"));
        templateSensitivityFrame->setMinimumSize(QSize(260, 38));
        templateSensitivityFrame->setMaximumSize(QSize(260, 38));
        horizontalLayout_templateSensitivityButtons = new QHBoxLayout(templateSensitivityFrame);
        horizontalLayout_templateSensitivityButtons->setSpacing(0);
        horizontalLayout_templateSensitivityButtons->setObjectName(QString::fromUtf8("horizontalLayout_templateSensitivityButtons"));
        horizontalLayout_templateSensitivityButtons->setContentsMargins(0, 0, 0, 0);
        templateManualButton = new QPushButton(templateSensitivityFrame);
        templateManualButton->setObjectName(QString::fromUtf8("templateManualButton"));
        templateManualButton->setCheckable(true);

        horizontalLayout_templateSensitivityButtons->addWidget(templateManualButton);

        templateAutoButton = new QPushButton(templateSensitivityFrame);
        templateAutoButton->setObjectName(QString::fromUtf8("templateAutoButton"));
        templateAutoButton->setCheckable(true);
        templateAutoButton->setChecked(true);

        horizontalLayout_templateSensitivityButtons->addWidget(templateAutoButton);


        horizontalLayout_templateSensitivity->addWidget(templateSensitivityFrame);


        verticalLayout_searchTemplate->addLayout(horizontalLayout_templateSensitivity);
        ...
        sensitivityLabel = new QLabel(searchTemplateCard);
        ...
        sensitivitySpinBox = new QSpinBox(searchTemplateCard);
        sensitivitySpinBox->setObjectName(QString::fromUtf8("sensitivitySpinBox"));
        sensitivitySpinBox->setMinimumSize(QSize(260, 38));
        sensitivitySpinBox->setMinimum(1);
        sensitivitySpinBox->setMaximum(10);
        sensitivitySpinBox->setValue(2);

        horizontalLayout_sensitivity->addWidget(sensitivitySpinBox);


        verticalLayout_searchTemplate->addLayout(horizontalLayout_sensitivity);


        verticalLayout_configCards->addWidget(searchTemplateCard);

        detectionAreaCard = new QFrame(patternConfigContents);
        ...
        recognitionSettingsCard = new QFrame(patternConfigContents);
        ...
        resultJudgeCard = new QFrame(patternConfigContents);
        ...
        patternConfigScrollArea->setWidget(patternConfigContents);

        verticalLayout_allParamsPage->addWidget(patternConfigScrollArea);

        patternParamsStackedWidget->addWidget(allParamsPage);

        verticalLayout_editor->addWidget(patternParamsStackedWidget);
        ...
        retranslateUi(PatternPresenceDialog);
        QObject::connect(basicResultBasisComboBox, SIGNAL(currentIndexChanged(int)), resultBasisComboBox, SLOT(setCurrentIndex(int)));
        QObject::connect(resultBasisComboBox, SIGNAL(currentIndexChanged(int)), basicResultBasisComboBox, SLOT(setCurrentIndex(int)));

        patternParamsStackedWidget->setCurrentIndex(1);
        ...
        QMetaObject::connectSlotsByName(PatternPresenceDialog);
    } // setupUi

    void retranslateUi(QDialog *PatternPresenceDialog)
    {
        PatternPresenceDialog->setWindowTitle(QCoreApplication::translate("PatternPresenceDialog", "\346\226\271\346\241\210\347\274\226\350\276\221 - \345\233\276\346\241\210\346\234\211\346\227\240", nullptr));
        setupWindowTitleLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\346\226\271\346\241\210\347\274\226\350\276\221", nullptr));
        headerMaximizeButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\342\226\241", nullptr));
        headerCloseButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\303\227", nullptr));
        setupPageCodeLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "422", nullptr));
        setupSaveButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\344\277\235\345\255\230", nullptr));
        setupSaveAsButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\345\217\246\345\255\230\344\270\272", nullptr));
        setupExportButton->setText(QCoreApplication::translate("PatternPresenceDialog", "IO\350\276\223\345\207\272", nullptr));
        editorTitleLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\345\233\276\346\241\210\346\234\211\346\227\240", nullptr));
        basicSegmentButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\345\237\272\347\241\200", nullptr));
        allSegmentButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\345\205\250\351\203\250", nullptr));
        basicSearchTemplateCard->setProperty("panelRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "configCard", nullptr)));
        basicSearchTemplateTitleLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\346\220\234\347\264\242\346\250\241\346\235\277", nullptr));
        basicSearchTemplateTitleLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "cardTitle", nullptr)));
        basicTemplateCollapseButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\342\214\204", nullptr));
        basicTemplateCollapseButton->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "collapseCard", nullptr)));
        basicTemplateAreaLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\346\250\241\346\235\277\345\214\272\345\237\237", nullptr));
        basicTemplateAreaLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        basicTemplateRectButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\342\226\241", nullptr));
        basicTemplateRectButton->setProperty("actionRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "toolbarIcon", nullptr)));
        basicTemplatePolygonButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\342\254\241", nullptr));
        basicTemplatePolygonButton->setProperty("actionRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "toolbarIcon", nullptr)));
        basicTemplateFinishButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\345\256\214\346\210\220", nullptr));
        basicTemplateFinishButton->setProperty("actionRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "highlight", nullptr)));
        basicSensitivityLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\347\201\265\346\225\217\345\272\246 \342\223\230", nullptr));
        basicSensitivityLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        basicDetectionAreaCard->setProperty("panelRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "configCard", nullptr)));
        basicDetectionAreaTitleLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\346\243\200\346\265\213\345\214\272\345\237\237", nullptr));
        basicDetectionAreaTitleLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "cardTitle", nullptr)));
        basicDetectionCollapseButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\342\214\204", nullptr));
        basicDetectionCollapseButton->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "collapseCard", nullptr)));
        basicDetectionAreaLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\346\243\200\346\265\213\345\214\272", nullptr));
        basicDetectionAreaLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        basicDetectionRectButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\342\226\241", nullptr));
        basicDetectionCircleButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\342\227\213", nullptr));
        basicPositionEnableLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\347\213\254\347\253\213\344\275\215\347\275\256\344\277\256\346\255\243\344\275\277\350\203\275 \342\223\230", nullptr));
        basicPositionEnableLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        basicPositionCorrectionSwitch->setText(QString());
        basicPositionSourceLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\344\275\215\347\275\256\344\277\256\346\255\243", nullptr));
        basicPositionSourceLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        basicPositionCorrectionComboBox->setItemText(0, QCoreApplication::translate("PatternPresenceDialog", "1 \345\237\272\345\207\206\345\233\276.\344\275\215\347\275\256\344\277\256\346\255\243\344\277\241\346\201\257", nullptr));

        basicRecognitionSettingsCard->setProperty("panelRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "configCard", nullptr)));
        basicRecognitionSettingsTitleLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\350\257\206\345\210\253\350\256\276\347\275\256", nullptr));
        basicRecognitionSettingsTitleLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "cardTitle", nullptr)));
        basicRecognitionCollapseButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\342\214\204", nullptr));
        basicRecognitionCollapseButton->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "collapseCard", nullptr)));
        basicShowContourLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\350\277\220\350\241\214\346\230\276\347\244\272\350\275\256\345\273\223\347\202\271", nullptr));
        basicShowContourLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        basicShowContourSwitch->setText(QString());
        basicResultJudgeCard->setProperty("panelRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "configCard", nullptr)));
        basicResultJudgeTitleLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\347\273\223\346\236\234\345\210\244\346\226\255", nullptr));
        basicResultJudgeTitleLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "cardTitle", nullptr)));
        basicResultCollapseButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\342\214\204", nullptr));
        basicResultCollapseButton->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "collapseCard", nullptr)));
        basicResultBasisLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\345\210\244\346\226\255\344\276\235\346\215\256", nullptr));
        basicResultBasisLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        basicResultBasisComboBox->setItemText(0, QCoreApplication::translate("PatternPresenceDialog", "\347\273\223\346\236\234\346\234\211\346\227\240", nullptr));
        basicResultBasisComboBox->setItemText(1, QCoreApplication::translate("PatternPresenceDialog", "\346\234\200\344\275\216\345\276\227\345\210\206", nullptr));

        basicResultPresenceLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\347\273\223\346\236\234\346\234\211\346\227\240", nullptr));
        basicResultPresenceLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        basicResultPresenceFrame->setProperty("panelRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "optionGroup", nullptr)));
        basicPresentOkButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\345\255\230\345\234\250OK", nullptr));
        basicAbsentOkButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\344\270\215\345\255\230\345\234\250OK", nullptr));
        basicResultScoreLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\346\234\200\344\275\216\345\276\227\345\210\206", nullptr));
        basicResultScoreLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        searchTemplateCard->setProperty("panelRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "configCard", nullptr)));
        searchTemplateTitleLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\346\220\234\347\264\242\346\250\241\346\235\277", nullptr));
        searchTemplateTitleLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "cardTitle", nullptr)));
        templateCollapseButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\342\214\204", nullptr));
        templateCollapseButton->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "collapseCard", nullptr)));
        templateAreaLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\346\250\241\346\235\277\345\214\272\345\237\237", nullptr));
        templateAreaLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        templateRectButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\342\226\241", nullptr));
        templateRectButton->setProperty("actionRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "toolbarIcon", nullptr)));
        templatePolygonButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\342\254\241", nullptr));
        templatePolygonButton->setProperty("actionRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "toolbarIcon", nullptr)));
        templateFinishButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\345\256\214\346\210\220", nullptr));
        templateFinishButton->setProperty("actionRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "highlight", nullptr)));
        templateMaskLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\346\250\241\346\235\277\345\261\217\350\224\275\345\214\272\345\237\237", nullptr));
        templateMaskLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        templateMaskEditButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\347\274\226\350\276\221", nullptr));
        templateMaskEditButton->setProperty("actionRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "gray", nullptr)));
        templateSensitivityLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\346\250\241\346\235\277\347\201\265\346\225\217\345\272\246", nullptr));
        templateSensitivityLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        templateSensitivityFrame->setProperty("panelRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "optionGroup", nullptr)));
        templateManualButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\346\211\213\345\212\250\346\250\241\345\274\217", nullptr));
        templateAutoButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\350\207\252\345\212\250", nullptr));
        sensitivityLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\347\201\265\346\225\217\345\272\246 \342\223\230", nullptr));
        sensitivityLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        detectionAreaCard->setProperty("panelRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "configCard", nullptr)));
        detectionAreaTitleLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\346\243\200\346\265\213\345\214\272\345\237\237", nullptr));
        detectionAreaTitleLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "cardTitle", nullptr)));
        detectionCollapseButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\342\214\204", nullptr));
        detectionCollapseButton->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "collapseCard", nullptr)));
        detectionAreaLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\346\243\200\346\265\213\345\214\272", nullptr));
        detectionAreaLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        detectionRectButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\342\226\241", nullptr));
        detectionCircleButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\342\227\213", nullptr));
        detectionMaskLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\345\261\217\350\224\275\345\214\272\345\237\237", nullptr));
        detectionMaskLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        detectionMaskEditButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\347\274\226\350\276\221", nullptr));
        detectionMaskEditButton->setProperty("actionRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "gray", nullptr)));
        positionEnableLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\347\213\254\347\253\213\344\275\215\347\275\256\344\277\256\346\255\243\344\275\277\350\203\275 \342\223\230", nullptr));
        positionEnableLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        positionCorrectionSwitch->setText(QString());
        positionSourceLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\344\275\215\347\275\256\344\277\256\346\255\243", nullptr));
        positionSourceLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        positionCorrectionComboBox->setItemText(0, QCoreApplication::translate("PatternPresenceDialog", "1 \345\237\272\345\207\206\345\233\276.\344\275\215\347\275\256\344\277\256\346\255\243\344\277\241\346\201\257", nullptr));

        recognitionSettingsCard->setProperty("panelRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "configCard", nullptr)));
        recognitionSettingsTitleLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\350\257\206\345\210\253\350\256\276\347\275\256", nullptr));
        recognitionSettingsTitleLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "cardTitle", nullptr)));
        recognitionCollapseButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\342\214\204", nullptr));
        recognitionCollapseButton->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "collapseCard", nullptr)));
        minScoreLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\346\234\200\345\260\217\345\276\227\345\210\206", nullptr));
        minScoreLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        matchPolarityLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\345\214\271\351\205\215\346\236\201\346\200\247 \342\223\230", nullptr));
        matchPolarityLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        matchPolarityComboBox->setItemText(0, QCoreApplication::translate("PatternPresenceDialog", "\344\270\215\350\200\203\350\231\221\346\236\201\346\200\247", nullptr));
        matchPolarityComboBox->setItemText(1, QCoreApplication::translate("PatternPresenceDialog", "\350\200\203\350\231\221\346\236\201\346\200\247", nullptr));

        scaleRangeLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\345\260\272\345\272\246\350\214\203\345\233\264 \342\223\230", nullptr));
        scaleRangeLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        scaleDashLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "-", nullptr));
        angleRangeLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\350\247\222\345\272\246\350\214\203\345\233\264 \342\223\230", nullptr));
        angleRangeLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        angleDashLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "-", nullptr));
        timeoutLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\347\256\227\346\263\225\350\266\205\346\227\266\346\227\266\351\227\264(ms)", nullptr));
        timeoutLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        showContourLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\350\277\220\350\241\214\346\230\276\347\244\272\350\275\256\345\273\223\347\202\271", nullptr));
        showContourLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        showContourSwitch->setText(QString());
        sortModeLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\346\216\222\345\272\217\346\226\271\345\274\217", nullptr));
        sortModeLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        sortModeComboBox->setItemText(0, QCoreApplication::translate("PatternPresenceDialog", "\346\214\211X\345\235\220\346\240\207\344\273\216\345\260\217\345\210\260\345\244\247\346\216\222\345\272\217", nullptr));
        sortModeComboBox->setItemText(1, QCoreApplication::translate("PatternPresenceDialog", "\346\214\211X\345\235\220\346\240\207\344\273\216\345\244\247\345\210\260\345\260\217\346\216\222\345\272\217", nullptr));
        sortModeComboBox->setItemText(2, QCoreApplication::translate("PatternPresenceDialog", "\346\214\211Y\345\235\220\346\240\207\344\273\216\345\260\217\345\210\260\345\244\247\346\216\222\345\272\217", nullptr));
        sortModeComboBox->setItemText(3, QCoreApplication::translate("PatternPresenceDialog", "\346\214\211Y\345\235\220\346\240\207\344\273\216\345\244\247\345\210\260\345\260\217\346\216\222\345\272\217", nullptr));
        sortModeComboBox->setItemText(4, QCoreApplication::translate("PatternPresenceDialog", "\346\214\211\345\276\227\345\210\206\344\273\216\345\260\217\345\210\260\345\244\247\346\216\222\345\272\217", nullptr));
        sortModeComboBox->setItemText(5, QCoreApplication::translate("PatternPresenceDialog", "\346\214\211\345\276\227\345\210\206\344\273\216\345\244\247\345\210\260\345\260\217\346\216\222\345\272\217", nullptr));
        sortModeComboBox->setItemText(6, QCoreApplication::translate("PatternPresenceDialog", "\346\214\211\350\247\222\345\272\246\344\273\216\345\260\217\345\210\260\345\244\247\346\216\222\345\272\217", nullptr));
        sortModeComboBox->setItemText(7, QCoreApplication::translate("PatternPresenceDialog", "\346\214\211\350\247\222\345\272\246\344\273\216\345\244\247\345\210\260\345\260\217\346\216\222\345\272\217", nullptr));
        sortModeComboBox->setItemText(8, QCoreApplication::translate("PatternPresenceDialog", "\346\214\211ROI\345\272\217\345\217\267\346\216\222\345\272\217", nullptr));

        resultJudgeCard->setProperty("panelRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "configCard", nullptr)));
        resultJudgeTitleLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\347\273\223\346\236\234\345\210\244\346\226\255", nullptr));
        resultJudgeTitleLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "cardTitle", nullptr)));
        resultCollapseButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\342\214\204", nullptr));
        resultCollapseButton->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "collapseCard", nullptr)));
        resultBasisLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\345\210\244\346\226\255\344\276\235\346\215\256", nullptr));
        resultBasisLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        resultBasisComboBox->setItemText(0, QCoreApplication::translate("PatternPresenceDialog", "\347\273\223\346\236\234\346\234\211\346\227\240", nullptr));
        resultBasisComboBox->setItemText(1, QCoreApplication::translate("PatternPresenceDialog", "\346\234\200\344\275\216\345\276\227\345\210\206", nullptr));

        resultPresenceLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\347\273\223\346\236\234\346\234\211\346\227\240", nullptr));
        resultPresenceLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        resultPresenceFrame->setProperty("panelRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "optionGroup", nullptr)));
        presentOkButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\345\255\230\345\234\250OK", nullptr));
        absentOkButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\344\270\215\345\255\230\345\234\250OK", nullptr));
        resultScoreLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\346\234\200\344\275\216\345\276\227\345\210\206", nullptr));
        resultScoreLabel->setProperty("role", QVariant(QCoreApplication::translate("PatternPresenceDialog", "rowField", nullptr)));
        referenceTestButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\345\237\272\345\207\206\345\233\276\346\265\213\350\257\225", nullptr));
        referenceTestButton->setProperty("actionRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "secondary", nullptr)));
        testRunButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\346\265\213\350\257\225\350\277\220\350\241\214", nullptr));
        testRunButton->setProperty("actionRole", QVariant(QCoreApplication::translate("PatternPresenceDialog", "secondary", nullptr)));
        finishButton->setText(QCoreApplication::translate("PatternPresenceDialog", "\345\256\214\346\210\220", nullptr));
        viewerTitleLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\345\237\272\345\207\206\345\233\276", nullptr));
        viewerZoomOutButton->setText(QCoreApplication::translate("PatternPresenceDialog", "-", nullptr));
        viewerZoomLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "39%", nullptr));
        viewerStatusLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "\347\256\227\346\263\225\350\200\227\346\227\266: --ms   \345\267\245\345\205\267\350\200\227\346\227\266: --ms", nullptr));
        viewerCursorLabel->setText(QCoreApplication::translate("PatternPresenceDialog", "X: --  Y: ---   |   R: -- G: -- B: --", nullptr));
    } // retranslateUi

};

namespace Ui {
    class PatternPresenceDialog: public Ui_PatternPresenceDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_PATTERNPRESENCEDIALOG_H
